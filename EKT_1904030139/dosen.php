...
$camaba = query("SELECT * FROM dosen_unis");

if (isset($_POST['cari_dosen'])) {
  $camaba = cari_dosen($_POST['keyword']);
}
...
<body>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!--konten  -->
      <h3> <i class="fas fa-users"></i> Daftar Dosen Mahasiswa </h3>
      <hr>
      <!-- Pencarian Data -->

      <form action="" method="POST">
        <input type="text" id="keyword" size="50" name="keyword" placeholder="masukan keywords" autocomplete="off">
        <button type="submit" class="btn btn-primary" name="cari_dosen">CARI</button>
      </form>
      <hr>
        ...
        <tbody>
          ...
          <?php foreach ($camaba  as  $cmb) : ?>
            ...
            <tr>
              ...
              <td> <a href="detail_dosen.php?id=<?= $cmb['id']; ?>" class="btn btn-warning" role="button">detail</a></td>
            </tr>
            <?php $no++; ?>
          <?php endforeach ?>
