...
<body>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!--konten  -->
      <h3> <i class="fas fa-users"></i> Edit Data dosen </h3>
      <hr>
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nidn" value="<?= $camaba['nidn'] ?>" placeholder="nidn lengkap" name="nidn" autofocus required autocomplete="off">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="email" value="<?= $camaba['email'] ?>" placeholder="email" name="email" autofocus required autocomplete="off">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="pend1">Pendidikan 1 :</label>
          <input type="text" class="form-control" id="pend1" value="<?= $camaba['pend1'] ?>" placeholder="pendidikan 1" name="pend1" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="pend1">Pendidikan 2 :</label>
          <input type="text" class="form-control" id="pend2" value="<?= $camaba['pend2'] ?>" placeholder="pendidikan 2" name="pend2" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="pend3">Pendidikan 3 :</label>
          <input type="text" class="form-control" id="pend3" value="<?= $camaba['pend3'] ?>" placeholder="pendidikan 3" name="pend3" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="foto_dosen">Foto :</label>
          <input type="text" class="form-control" id="foto_dosen" value="<?= $camaba['foto_dosen'] ?>" placeholder="foto" name="foto_dosen" required autocomplete="off">
        </div>

        <button type="submit" class="btn btn-primary" name="edit_dosen">Simpan</button>
      </form>
